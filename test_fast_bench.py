...
elements = [0.1 for n in range(DEFAULT_LENGTH)]
...
ALL_STMT_TEST = {
    ...
    "Mead sort (M)": create_stmt("meadsort_m", load_file("sort/meadsort/meadsort.py")),
    ...
    # "Mead sort (ZK)": create_stmt("meadsort_zk", load_file("sort/meadsort/meadsort.py")),
}
